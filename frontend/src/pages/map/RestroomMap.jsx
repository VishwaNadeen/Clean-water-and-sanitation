  ...
  return (
    <div className="flex" style={{ height: "calc(100vh - 72px)" }}>
      ...
      <div className={`flex-shrink-0 flex flex-col bg-white shadow-xl z-10 border-r border-slate-200 relative transition-all duration-300 ${sidebarOpen ? "w-96" : "w-0 overflow-hidden"}`}>
        ...
        {/* detail view */}
        {selectedRestroom ? (
          <div className="restroom-scrollbar flex-1 overflow-y-auto">
          ...
          /* list view */
          <div className="restroom-scrollbar flex-1 overflow-y-auto flex flex-col">
      ...
      <div className="relative flex-shrink-0">
        <button
          ...
          className="absolute top-1/2 -translate-y-1/2 left-0 z-40 bg-white border border-slate-200 shadow-md rounded-r-xl px-1 py-4 text-slate-500 hover:text-blue-600 hover:bg-blue-50 transition-colors"
      ...
      {/* map */}
      <div className="restroom-map-area flex-1 relative">
        {/* locate me button */}
        ...
        {userLocation && userLocation.accuracy > 500 && (
          <div className="absolute bottom-10 right-3 z-40 bg-yellow-50 border border-yellow-200 rounded-xl px-3 py-2 shadow-md max-w-[200px]">
        ...
        {loadingOsm && (
          <div className="absolute bottom-6 right-3 z-40 bg-white border border-slate-200 rounded-full px-3 py-1.5 shadow text-xs text-slate-500 flex items-center gap-2">
      ...
      <style>{`
        .restroom-scrollbar {
          ...
          scrollbar-color: #38bdf8 #bae6fd;
        }

        .restroom-scrollbar::-webkit-scrollbar {
          width: 6px;
        }

        .restroom-scrollbar::-webkit-scrollbar-track {
          background: #bae6fd;
          border-radius: 9999px;
        }

        .restroom-scrollbar::-webkit-scrollbar-thumb {
          background: linear-gradient(180deg, #7dd3fc 0%, #38bdf8 100%);
          border-radius: 9999px;
        }

        .restroom-scrollbar::-webkit-scrollbar-thumb:hover {
          background: linear-gradient(180deg, #38bdf8 0%, #0ea5e9 100%);
        }

        .restroom-map-area .leaflet-top,
        .restroom-map-area .leaflet-bottom,
        .restroom-map-area .leaflet-control,
        .restroom-map-area .leaflet-pane,
        .restroom-map-area .leaflet-popup {
