              ...
              <nav className="hidden items-center gap-[2px] md:flex">
                {navLinks.map(({ to, label }, index) => (
                  ...
                  >
                    ...
                    <span className="pointer-events-none absolute bottom-[5px] left-1/2 h-[2px] w-0 -translate-x-1/2 rounded-full bg-white/95 transition-all duration-200 ease-out group-hover:w-[55%]" />
